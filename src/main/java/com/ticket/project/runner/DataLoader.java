package com.ticket.project.runner;

import com.ticket.project.data.entity.Movie;
import com.ticket.project.data.entity.Screen;
import com.ticket.project.data.entity.Screening;
import com.ticket.project.data.repository.MovieRepository;
import com.ticket.project.data.repository.ScreenRepository;
import com.ticket.project.data.repository.ScreeningRepository;
...
public class DataLoader implements ApplicationRunner {
    ...
    private void populateScreeningsTable() throws CloneNotSupportedException {
         ...
         */
        for (int i = 1; i <= 5; i++) {
            List<Screen> screens = screenRepository.findByTheaterId(i);
            for (int j = 0; j < screens.size(); j++) {
                Screening screening1 = new Screening();
                Screening screening2 = new Screening();

                screening1.setTheaterId((long) i);
                screening1.setScreenId((long) (j+1));
                screening2.setTheaterId((long) i);
                screening2.setScreenId((long) (j+1));
